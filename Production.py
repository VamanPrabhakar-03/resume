...
# Global CSS styling for light, elegant theme
st.markdown("""
    <style>
    body {
...
def run():
    ...
    st.sidebar.markdown("""
        <h1 style='color:#273746;'>🔍 Choose Mode</h1>
    """, unsafe_allow_html=True)

    activities = ["👤 User", "🛠️ Admin"]
    choice = st.sidebar.selectbox("Choose Role:", activities)

    st.sidebar.markdown("""
        <hr style="border-top: 1px solid #bbb;">
        <h4 style='color:#273746;'>📬 Contact Developer</h4>
        <a href='https://www.linkedin.com/in/vaman-prabakar-32b6072a1/' target='_blank'>💼 Vaman Prabhakar</a>
    """, unsafe_allow_html=True)
    ...
    if choice == "👤 User":
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if no_of_pages == 1:
                    cand_level = "Fresher"
                    st.success("🌱 You are at **Fresher** level!")
                    ...
                    st.warning("🌳 You are at **Experienced** level!")
                ...
                if selected_jd:
                    ...
                    with st.container():
                        st.markdown("<h4 style='color:#003366;'>💡 AI-Generated Resume Summary:</h4>",
                                    unsafe_allow_html=True)
